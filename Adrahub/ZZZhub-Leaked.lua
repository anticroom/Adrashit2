	...
	getgenv().GetNearestTarget = function()
		...
		for L_52_forvar0, L_53_forvar1 in pairs(L_46_) do
			if L_53_forvar1.Character ~= nil then
				...
				elseif getgenv().TeamCheck == true and L_53_forvar1.Team == L_31_.Team then
					local L_60_ =
                            (L_53_forvar1.Character:FindFirstChild("Head").Position - game.Workspace.CurrentCamera.CFrame.p).magnitude
					local L_61_ =
                            Ray.new(
...
local L_8_ = L_7_:NewSection("Zzz's Hub")
L_8_:NewButton(
    "Silent Aim",
    "Silent Aim Toggle Key is T.",
    function()
	loadstring(game:HttpGet("https://pastebin.com/raw/GZ3AJ7GP", true))()
end
)
L_8_:NewTextBox(
...
local L_10_ = L_9_:NewSection("Zzz's Hub")
L_10_:NewButton(
    "Silent Aimlock",
    "Key is C.",
    function()
...
local L_12_ = L_11_:NewSection("Zzz's Hub")
L_12_:NewButton(
    "Anti-Lock",
    "Key is Z.",
    function()
...
local L_14_ = L_13_:NewSection("Zzz's Hub")
L_14_:NewKeybind(
    "Keybind Gui Toggle",
    "h",
    Enum.KeyCode.V,
...
L_14_:NewButton(
	...
	function sFLY(L_157_arg0)
		...
		local function L_162_func()
			...
			spawn(
				...
				repeat
					...
					if L_159_.L + L_159_.R ~= 0 or L_159_.F + L_159_.B ~= 0 or L_159_.C + L_159_.E ~= 0 then
						L_161_ = 50
					elseif not (L_159_.L + L_159_.R ~= 0 or L_159_.F + L_159_.B ~= 0 or L_159_.C + L_159_.E ~= 0) and L_161_ ~= 0 then
						L_161_ = 0
					end
					if L_159_.L + L_159_.R ~= 0 or L_159_.F + L_159_.B ~= 0 or L_159_.C + L_159_.E ~= 0 then
						L_164_.velocity =
		...
		IYMouse.KeyDown:connect(
			...
			elseif QEfly and L_165_arg0:lower() == "c" then
				if L_157_arg0 then
		...
		IYMouse.KeyUp:connect(
			...
			elseif L_166_arg0:lower() == "e" then
				L_159_.Q = 0
			elseif L_166_arg0:lower() == "c" then
				L_159_.E = 0
			end
		end
            )
...
local L_19_ = L_17_:NewSection("Zzz's Hub")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
...
L_19_:NewToggle(
    ...
    "Health Bar.",
    function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/zzzsmokedyou/sadada/main/ada"))()
end
)
L_19_:NewToggle(
    "Boxes",
...
local L_16_ = L_15_:NewSection("(UPDATING ATM!)")
L_16_:NewButton(
    "Admin Base",
    "fr",
    function()
...
local L_7_ = L_4_:NewTab("Inf Yield")
local L_8_ = L_7_:NewSection("Zzz's Hub")
L_8_:NewButton(
    "Inf Yield",
    "Inf Yield.",
